...
export function normalizeMetric(rawValue: unknown): NoiseMetric {
  ...
  return {
    ...
    medianDbLevel: numberField(raw, [
      'median_db_level',
      'hourly_median_db_level',
      'daily_median_db_level',
      'median',
      'hourly_median',
    ]),
    exceedances: numberField(raw, [
      'no_of_exceedances',
      'hourly_no_of_exceedances',
      'daily_no_of_exceedances',
      'exceedances',
      'exceedance_count',
    ]),
    ...
    uploadedAt: stringField(raw, ['time_uploaded', 'uploaded_at', 'created_at', 'timestamp', 'date']),
  };
}
